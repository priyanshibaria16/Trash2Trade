...
This project consists of two main components in separate folders:

```
Trash2trade-Nexothon-main/
...
1. **Frontend** - A React/JavaScript application with Vite, shadcn-ui, and Tailwind CSS
...
Create a `.env` in the frontend directory for API base:
