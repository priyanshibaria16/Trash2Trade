...
function jitter(n, spread = 0.02) { // ~2km-3km jitter
...
function makeEmail(first, last, i) { return `${first.toLowerCase()}.${last.toLowerCase()}${Date.now()}${i}@example.in`; }
function makeAddress(city) { return `${randInt(1, 999)}, ${['MG Road','MG Rd','Station Rd','Ring Rd','Nehru Marg','GT Road'][randInt(0,5)]}, ${city}, India`; }
